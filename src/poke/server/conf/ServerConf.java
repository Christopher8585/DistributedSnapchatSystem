...
public class ServerConf {
	...
	@XmlAccessorType(XmlAccessType.FIELD)
	public static final class ClusterConf {
		private TreeMap<String, ClusterDesc> cluster;

		public ClusterDesc getNode(String name) {
			return cluster.get(name);
		}

		public void add(ClusterDesc node) {
			if (node == null)
				return;
			else if (cluster == null)
				cluster = new TreeMap<String, ClusterDesc>();

			//cluster.put(node, node);  //###
		}

		public TreeMap<String, ClusterDesc> getClusterNodes() {
			return cluster;
		}

		public void setClusterNodes(TreeMap<String, ClusterDesc> nearest) {
			this.cluster = nearest;
		}
	}
	*/
}
