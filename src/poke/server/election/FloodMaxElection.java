...
public class FloodMaxElection implements Election {
	 ...
	 * @param nodeId
	 */
	public FloodMaxElection(int nodeId) {
		this.nodeId = nodeId;
	}
	...
	public Management process(Management mgmt) {
		...
		if (req.getAction().getNumber() == ElectAction.DECLAREELECTION_VALUE) {
			...
			// required to el-iminate duplicate messages - on a declaration,
			...
			System.out.println("   Votes:         " + req.getVotesCount());
			System.out.println("   Index:         " + req.getIndex());
